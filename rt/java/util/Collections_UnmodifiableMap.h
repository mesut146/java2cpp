...
class UnmodifiableMap: public Map<K, V>, public java::io::Serializable{
//fields
public:
    std::unordered_set<Entry<K, V>*>* entrySet_renamed;
    std::unordered_set<K>* keySet_renamed;
    Map<java::lang::Object*, java::lang::Object*>* m;
    static long serialVersionUID;
    Collection<V>* values_renamed;

//methods
public:
    UnmodifiableMap(Map<java::lang::Object*, java::lang::Object*>* );
